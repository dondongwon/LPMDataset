...
def validate(test_connect_json, data_loader, model, args, epoch=-1, best_score=None, evaluation = False, human_study = False):
  # switch to eval mode
  model.eval()
  ...
  if args.eval:
    ...
    # Dataloaders
      ...
      if args.slide_level:
        ...
        trn_loader = data.get_loaders(cap_json, fig_json, no_rep_connect_json, vocab, root_dir, args.batch_size, args.wemb_type, args.model, 'train')
